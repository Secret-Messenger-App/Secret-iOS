...
extern NSString *const kOTRXLFormProxyHostTextFieldTag;
extern NSString *const kOTRXLFormProxyPortTextFieldTag;
extern NSString *const kOTRXLFormProxyUserTextFieldTag;
extern NSString *const kOTRXLFormProxyPassTextFieldTag;
