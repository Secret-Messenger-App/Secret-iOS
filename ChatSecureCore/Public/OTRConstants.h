...
extern NSString *const kOTRDeviceToken;
extern NSString *const kOTRUsePasscodeKey;
extern NSString *const kOTRUseBackgroundAudioKey;
extern NSString *const kOTRUseFastPlaybackKey;
