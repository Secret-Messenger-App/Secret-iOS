...
public class ServerCapabilitiesViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        ...
        case .Push:
            return nil //CHATSECURE_PUSH_STRING()
        case .Server:
            return nil//Server_String()
        }
    }
    ...
    public func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        switch tableSections[section] {
        case .Push:
            return 1;//cellCountForPushInfo(pushInfo: check.result.pushInfo)
        case .Server:
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .Push:
            ...
            emptyCell.textLabel?.text = self.check.serverCapabilities.serverHost()
            emptyCell.textLabel?.font = UIFont.boldSystemFont(ofSize: 18.0)
