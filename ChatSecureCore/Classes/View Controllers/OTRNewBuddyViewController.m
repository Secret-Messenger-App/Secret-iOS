...
-(IBAction)doneButtonPressed:(id)sender
{
    if ([self checkFields]) {
        ...
        if (newBuddyAccountName) {
            NSArray *components = [newBuddyAccountName componentsSeparatedByString:@"@"];
            if (components.count == 2) {
                // DDLog
            } else {
                newBuddyAccountName = [newBuddyAccountName stringByAppendingString:@"@secret.me"];
            }
        }
