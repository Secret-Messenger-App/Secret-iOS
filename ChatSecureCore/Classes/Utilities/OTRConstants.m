...
NSString *const kOTRServiceName            = @"ms.sec.ms";
NSString *const kOTRCertificateServiceName = @"ms.sec.ms.Certificate";
...
NSString *const kOTRErrorDomain = @"me.secret";
...
NSString *const kOTRDeviceToken = @"kOTRDeviceToken";
NSString *const kOTRUsePasscodeKey = @"kOTRUsePasscodeKey";
NSString *const kOTRUseBackgroundAudioKey = @"kOTRUseBackgroundAudioKey";
NSString *const kOTRUseFastPlaybackKey = @"kOTRUseFastPlaybackKey";
