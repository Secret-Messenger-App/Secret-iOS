...
public class ServerCheck: XMPPModule {
    ...
    @objc public override init(/*push: PushController,
                      pushModule: XMPPPushModule,*/
                      dispatchQueue: DispatchQueue?) {
        //NSLog("ServerCheck init")
        //self.push = push
        ...
        xmppCapabilities.addDelegate(self, delegateQueue: moduleQueue)
    ...
    @objc public func getCombinedPushStatus() -> ServerCheckPushStatus {
        //NSLog("ServerCheck getCombinedPushStatus")
    ...
    @objc private func pushAccountChanged(_ notification: Notification) {
        //NSLog("ServerCheck pushAccountChanged")
